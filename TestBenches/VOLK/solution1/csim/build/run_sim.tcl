...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2013.4/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2013.4/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2013.4/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2013.4/win64/tools/fir_v7_0"
### C sim ###
