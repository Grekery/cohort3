#include <math.h>         // declaration is in here
#include <stdio.h>
#include <stdlib.h>
...
//namespace gr {
  ...
  *****************************************************************************/
  ...
  float fast_atan2f(float y, float x)
  {
	  ...
	  y_abs = fabsf(y);
	  x_abs = fabsf(x);
	  //printf("%20.14f %20.14f %20.14f %20.14f \n", y, y_abs, x, x_abs);
	  ...
	  //printf("z=%0.14f, alpha=%0.14f, index=%d, base_angle=%0.14f \n", z, alpha, index, base_angle);
    ...
    //printf("angle=%20.14f, base_angle=%20.14f \n", angle, base_angle);
